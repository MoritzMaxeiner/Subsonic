...
/** Creates a socket and has methods to get a url to reference it. */
public abstract class ServerProxy implements Runnable {
	...
	/** Get a local url good for being passed internally to another application on the same device. */
	public String getPrivateAddress(String request) {
		return getAddress("127.0.0.1", request);
	}

	/** Get a url good for being passed to another device on the same LAN. */
