...
/**
 *  Streams a file which is being concurrently downloaded.
 *  Takes a BufferProgress object to determine when the file is finished downloading.
 *  This is useful for serving a song to a MediaPlayer which is still being downloaded.
...
public class BufferProxy extends FileProxy {
	...
	/** Set the buffer file which is used to query for the state of the download. */
